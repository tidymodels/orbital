...
operations as
[`orbital()`](https://orbital.tidymodels.org/reference/orbital.md), but
does not yet reach all of them. A model with no estimate is an error
...
[`orbital()`](https://orbital.tidymodels.org/reference/orbital.md) works
but `estimate_orbital_size()` does not, please [file an
issue](https://github.com/tidymodels/orbital/issues).

## See also

[`orbital()`](https://orbital.tidymodels.org/reference/orbital.md) for
generating orbital objects.
