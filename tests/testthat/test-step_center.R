...
test_that("step_center only calculates what is sufficient", {
  skip_if_not_installed("recipes")
...
test_that("step_center works with empty selections", {
  skip_if_not_installed("recipes")
...
test_that("estimate_step_chars works for step_center", {
  skip_if_not_installed("recipes")
...
test_that("estimate_step_chars works for step_center with empty selection", {
  skip_if_not_installed("recipes")
