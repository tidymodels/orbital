...
test_that("step_log only calculates what is sufficient", {
  skip_if_not_installed("recipes")
...
test_that("spark - step_log works", {
  skip_if_not_installed("recipes")
...
test_that("SQLite - step_log works", {
  skip_if_not_installed("recipes")
...
test_that("duckdb - step_log works", {
  skip_if_not_installed("recipes")
  skip_if_not_installed("DBI")
...
test_that("arrow - step_log works", {
  skip_if_not_installed("recipes")
...
test_that("estimate_step_chars works for step_log", {
  skip_if_not_installed("recipes")
...
test_that("estimate_step_chars works for step_log with empty selection", {
  skip_if_not_installed("recipes")
