test_that("boost_tree(engine = 'catboost'), objective = regression, works with type = numeric", {
...
test_that("boost_tree(engine = 'catboost'), objective = binary, works with type = class", {
  skip_if_not_installed("parsnip")
  skip_if_not_installed("bonsai")
  skip_if_not_installed("tidypredict")
  skip_if_not_installed("catboost")
...
test_that("boost_tree(engine = 'catboost'), objective = binary, works with type = prob", {
  skip_if_not_installed("parsnip")
  skip_if_not_installed("bonsai")
  skip_if_not_installed("tidypredict")
  skip_if_not_installed("catboost")
...
test_that("boost_tree(engine = 'catboost'), objective = binary, works with type = c(class, prob)", {
  skip_if_not_installed("parsnip")
  skip_if_not_installed("bonsai")
  skip_if_not_installed("tidypredict")
  skip_if_not_installed("catboost")
...
test_that("boost_tree(engine = 'catboost'), objective = multiclass, works with type = class", {
  skip_if_not_installed("parsnip")
  skip_if_not_installed("bonsai")
  skip_if_not_installed("tidypredict")
  skip_if_not_installed("catboost")
  ...
  # Use larger offset to avoid floating-point precision issues at
  # decision boundaries that can occur with catboost's tree split values
  iris[, -5] <- iris[, -5] + 0.07
...
test_that("boost_tree(engine = 'catboost'), objective = multiclass, works with type = prob", {
  skip_if_not_installed("parsnip")
  skip_if_not_installed("bonsai")
  skip_if_not_installed("tidypredict")
  skip_if_not_installed("catboost")
...
test_that("boost_tree(engine = 'catboost'), objective = multiclass, works with type = c(class, prob)", {
  skip_if_not_installed("parsnip")
  skip_if_not_installed("bonsai")
  skip_if_not_installed("tidypredict")
  skip_if_not_installed("catboost")
...
test_that("boost_tree(catboost) binary prob uses reference pattern", {
  skip_if_not_installed("parsnip")
  skip_if_not_installed("bonsai")
  skip_if_not_installed("tidypredict")
  skip_if_not_installed("catboost")
...
test_that("boost_tree(catboost) regression works with separate_trees = TRUE", {
  skip_if_not_installed("parsnip")
  skip_if_not_installed("bonsai")
  skip_if_not_installed("tidypredict")
  skip_if_not_installed("catboost")
...
test_that("boost_tree(catboost) binary classification works with separate_trees = TRUE", {
  skip_if_not_installed("parsnip")
  skip_if_not_installed("bonsai")
  skip_if_not_installed("tidypredict")
  skip_if_not_installed("catboost")
...
test_that("boost_tree(catboost) multiclass works with separate_trees = TRUE", {
  skip_if_not_installed("parsnip")
  skip_if_not_installed("bonsai")
  skip_if_not_installed("tidypredict")
  skip_if_not_installed("catboost")
