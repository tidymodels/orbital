...
[predict()](https://orbital.tidymodels.org/dev/reference/predict.orbital_class.md),
...
#> $.pred
#> <quosure>
#> expr: ^20.090625 + (cyl * -0.199023961804226) + (disp *
#>           1.65275221678761) + (hp * -1.47287569912409) + (drat *
#>           0.420851499782798) + (wt * -3.63526678164088) + (qsec *
#>           1.46715321419096) + (vs * 0.160157583474125) + (am *
#>           1.25757032609057) + (gear * 0.483566388425265) + (carb *
#>           -0.322101975983201)
#> env:  global
#> 
