...
- [`predict(`*`<orbital_class>`*`)`](https://orbital.tidymodels.org/dev/reference/predict.orbital_class.md)
  : Prediction using orbital objects
- [`augment(`*`<orbital_class>`*`)`](https://orbital.tidymodels.org/dev/reference/augment.orbital_class.md)
...
- [`orbital_dt()`](https://orbital.tidymodels.org/dev/reference/orbital_dt.md)
...
- [`orbital_sql()`](https://orbital.tidymodels.org/dev/reference/orbital_sql.md)
  : Convert to SQL code
- [`orbital_r_fun()`](https://orbital.tidymodels.org/dev/reference/orbital_r_fun.md)
