...
#> • MS_SubClass_One_and_Half_Story_Finished_All_Ages = dplyr::if_e ...
#> • MS_SubClass_Two_Story_1946_and_Newer = dplyr::if_else(MS_SubCl ...
#> • MS_SubClass_One_Story_PUD_1946_and_Newer = dplyr::if_else(MS_S ...
#> • MS_SubClass_other = dplyr::if_else(MS_SubClass == "other", 1, ...
#> • MS_Zoning_Residential_Medium_Density = dplyr::if_else(MS_Zonin ...
#> • MS_Zoning_other = dplyr::if_else(MS_Zoning == "other", 1, 0)
#> • Alley_other = dplyr::if_else(Alley == "other", 1, 0)
#> • Lot_Shape_Slightly_Irregular = dplyr::if_else(Lot_Shape == "Sl ...
#> • Land_Contour_other = dplyr::if_else(Land_Contour == "other", 1 ...
#> • Lot_Config_CulDSac = dplyr::if_else(Lot_Config == "CulDSac", 1 ...
#> • Lot_Config_Inside = dplyr::if_else(Lot_Config == "Inside", 1, ...
#> • Neighborhood_College_Creek = dplyr::if_else(Neighborhood == "C ...
#> • Neighborhood_Old_Town = dplyr::if_else(Neighborhood == "Old_To ...
#> • Neighborhood_Edwards = dplyr::if_else(Neighborhood == "Edwards ...
#> • Neighborhood_Somerset = dplyr::if_else(Neighborhood == "Somers ...
#> • Neighborhood_Northridge_Heights = dplyr::if_else(Neighborhood ...
#> • Neighborhood_Gilbert = dplyr::if_else(Neighborhood == "Gilbert ...
#> • Neighborhood_Sawyer = dplyr::if_else(Neighborhood == "Sawyer", ...
#> • Neighborhood_other = dplyr::if_else(Neighborhood == "other", 1 ...
#> • Condition_1_Norm = dplyr::if_else(Condition_1 == "Norm", 1, 0)
#> • Condition_1_other = dplyr::if_else(Condition_1 == "other", 1, ...
#> • Bldg_Type_TwnhsE = dplyr::if_else(Bldg_Type == "TwnhsE", 1, 0)
#> • Bldg_Type_other = dplyr::if_else(Bldg_Type == "other", 1, 0)
#> • House_Style_One_Story = dplyr::if_else(House_Style == "One_Sto ...
#> • House_Style_Two_Story = dplyr::if_else(House_Style == "Two_Sto ...
#> • House_Style_other = dplyr::if_else(House_Style == "other", 1, ...
#> • Overall_Cond_Above_Average = dplyr::if_else(Overall_Cond == "A ...
#> • Overall_Cond_Good = dplyr::if_else(Overall_Cond == "Good", 1, ...
#> • Overall_Cond_other = dplyr::if_else(Overall_Cond == "other", 1 ...
#> • Roof_Style_Hip = dplyr::if_else(Roof_Style == "Hip", 1, 0)
#> • Exterior_1st_Plywood = dplyr::if_else(Exterior_1st == "Plywood ...
#> • Exterior_1st_Wd.Sdng = dplyr::if_else(Exterior_1st == "Wd Sdng ...
#> • Exterior_1st_other = dplyr::if_else(Exterior_1st == "other", 1 ...
#> • Exterior_2nd_MetalSd = dplyr::if_else(Exterior_2nd == "MetalSd ...
#> • Exterior_2nd_Plywood = dplyr::if_else(Exterior_2nd == "Plywood ...
#> • Exterior_2nd_VinylSd = dplyr::if_else(Exterior_2nd == "VinylSd ...
#> • Exterior_2nd_Wd.Sdng = dplyr::if_else(Exterior_2nd == "Wd Sdng ...
#> • Exterior_2nd_other = dplyr::if_else(Exterior_2nd == "other", 1 ...
#> • Mas_Vnr_Type_None = dplyr::if_else(Mas_Vnr_Type == "None", 1, ...
#> • Mas_Vnr_Type_Stone = dplyr::if_else(Mas_Vnr_Type == "Stone", 1 ...
#> • Exter_Cond_Typical = dplyr::if_else(Exter_Cond == "Typical", 1 ...
#> • Foundation_CBlock = dplyr::if_else(Foundation == "CBlock", 1, ...
#> • Foundation_PConc = dplyr::if_else(Foundation == "PConc", 1, 0)
#> • Bsmt_Cond_other = dplyr::if_else(Bsmt_Cond == "other", 1, 0)
#> • Bsmt_Exposure_Gd = dplyr::if_else(Bsmt_Exposure == "Gd", 1, 0)
#> • Bsmt_Exposure_Mn = dplyr::if_else(Bsmt_Exposure == "Mn", 1, 0)
#> • Bsmt_Exposure_No = dplyr::if_else(Bsmt_Exposure == "No", 1, 0)
#> • BsmtFin_Type_1_BLQ = dplyr::if_else(BsmtFin_Type_1 == "BLQ", 1 ...
#> • BsmtFin_Type_1_GLQ = dplyr::if_else(BsmtFin_Type_1 == "GLQ", 1 ...
#> • BsmtFin_Type_1_LwQ = dplyr::if_else(BsmtFin_Type_1 == "LwQ", 1 ...
#> • BsmtFin_Type_1_Rec = dplyr::if_else(BsmtFin_Type_1 == "Rec", 1 ...
#> • BsmtFin_Type_1_Unf = dplyr::if_else(BsmtFin_Type_1 == "Unf", 1 ...
#> • BsmtFin_Type_2_other = dplyr::if_else(BsmtFin_Type_2 == "other ...
#> • Heating_QC_Good = dplyr::if_else(Heating_QC == "Good", 1, 0)
#> • Heating_QC_Typical = dplyr::if_else(Heating_QC == "Typical", 1 ...
#> • Central_Air_Y = dplyr::if_else(Central_Air == "Y", 1, 0)
#> • Electrical_SBrkr = dplyr::if_else(Electrical == "SBrkr", 1, 0)
#> • Functional_other = dplyr::if_else(Functional == "other", 1, 0)
#> • Garage_Type_BuiltIn = dplyr::if_else(Garage_Type == "BuiltIn", ...
#> • Garage_Type_Detchd = dplyr::if_else(Garage_Type == "Detchd", 1 ...
#> • Garage_Type_No_Garage = dplyr::if_else(Garage_Type == "No_Gara ...
#> • Garage_Finish_RFn = dplyr::if_else(Garage_Finish == "RFn", 1, ...
#> • Garage_Finish_Unf = dplyr::if_else(Garage_Finish == "Unf", 1, ...
#> • Garage_Cond_Typical = dplyr::if_else(Garage_Cond == "Typical", ...
#> • Paved_Drive_Paved = dplyr::if_else(Paved_Drive == "Paved", 1, ...
#> • Fence_No_Fence = dplyr::if_else(Fence == "No_Fence", 1, 0)
#> • Fence_other = dplyr::if_else(Fence == "other", 1, 0)
#> • Sale_Type_WD. = dplyr::if_else(Sale_Type == "WD ", 1, 0)
#> • Sale_Type_other = dplyr::if_else(Sale_Type == "other", 1, 0)
#> • Sale_Condition_Normal = dplyr::if_else(Sale_Condition == "Norm ...
#> • Sale_Condition_Partial = dplyr::if_else(Sale_Condition == "Par ...
...
#> <SQL> CASE WHEN (`MS_SubClass` = 'One_and_Half_Story_Finished_All_Ages') THEN 1.0 WHEN NOT (`MS_SubClass` = 'One_and_Half_Story_Finished_All_Ages') THEN 0.0 END AS MS_SubClass_One_and_Half_Story_Finished_All_Ages
#> <SQL> CASE WHEN (`MS_SubClass` = 'Two_Story_1946_and_Newer') THEN 1.0 WHEN NOT (`MS_SubClass` = 'Two_Story_1946_and_Newer') THEN 0.0 END AS MS_SubClass_Two_Story_1946_and_Newer
#> <SQL> CASE WHEN (`MS_SubClass` = 'One_Story_PUD_1946_and_Newer') THEN 1.0 WHEN NOT (`MS_SubClass` = 'One_Story_PUD_1946_and_Newer') THEN 0.0 END AS MS_SubClass_One_Story_PUD_1946_and_Newer
#> <SQL> CASE WHEN (`MS_SubClass` = 'other') THEN 1.0 WHEN NOT (`MS_SubClass` = 'other') THEN 0.0 END AS MS_SubClass_other
#> <SQL> CASE WHEN (`MS_Zoning` = 'Residential_Medium_Density') THEN 1.0 WHEN NOT (`MS_Zoning` = 'Residential_Medium_Density') THEN 0.0 END AS MS_Zoning_Residential_Medium_Density
#> <SQL> CASE WHEN (`MS_Zoning` = 'other') THEN 1.0 WHEN NOT (`MS_Zoning` = 'other') THEN 0.0 END AS MS_Zoning_other
#> <SQL> CASE WHEN (`Alley` = 'other') THEN 1.0 WHEN NOT (`Alley` = 'other') THEN 0.0 END AS Alley_other
#> <SQL> CASE WHEN (`Lot_Shape` = 'Slightly_Irregular') THEN 1.0 WHEN NOT (`Lot_Shape` = 'Slightly_Irregular') THEN 0.0 END AS Lot_Shape_Slightly_Irregular
#> <SQL> CASE WHEN (`Land_Contour` = 'other') THEN 1.0 WHEN NOT (`Land_Contour` = 'other') THEN 0.0 END AS Land_Contour_other
#> <SQL> CASE WHEN (`Lot_Config` = 'CulDSac') THEN 1.0 WHEN NOT (`Lot_Config` = 'CulDSac') THEN 0.0 END AS Lot_Config_CulDSac
#> <SQL> CASE WHEN (`Lot_Config` = 'Inside') THEN 1.0 WHEN NOT (`Lot_Config` = 'Inside') THEN 0.0 END AS Lot_Config_Inside
#> <SQL> CASE WHEN (`Neighborhood` = 'College_Creek') THEN 1.0 WHEN NOT (`Neighborhood` = 'College_Creek') THEN 0.0 END AS Neighborhood_College_Creek
#> <SQL> CASE WHEN (`Neighborhood` = 'Old_Town') THEN 1.0 WHEN NOT (`Neighborhood` = 'Old_Town') THEN 0.0 END AS Neighborhood_Old_Town
#> <SQL> CASE WHEN (`Neighborhood` = 'Edwards') THEN 1.0 WHEN NOT (`Neighborhood` = 'Edwards') THEN 0.0 END AS Neighborhood_Edwards
#> <SQL> CASE WHEN (`Neighborhood` = 'Somerset') THEN 1.0 WHEN NOT (`Neighborhood` = 'Somerset') THEN 0.0 END AS Neighborhood_Somerset
#> <SQL> CASE WHEN (`Neighborhood` = 'Northridge_Heights') THEN 1.0 WHEN NOT (`Neighborhood` = 'Northridge_Heights') THEN 0.0 END AS Neighborhood_Northridge_Heights
#> <SQL> CASE WHEN (`Neighborhood` = 'Gilbert') THEN 1.0 WHEN NOT (`Neighborhood` = 'Gilbert') THEN 0.0 END AS Neighborhood_Gilbert
#> <SQL> CASE WHEN (`Neighborhood` = 'Sawyer') THEN 1.0 WHEN NOT (`Neighborhood` = 'Sawyer') THEN 0.0 END AS Neighborhood_Sawyer
#> <SQL> CASE WHEN (`Neighborhood` = 'other') THEN 1.0 WHEN NOT (`Neighborhood` = 'other') THEN 0.0 END AS Neighborhood_other
#> <SQL> CASE WHEN (`Condition_1` = 'Norm') THEN 1.0 WHEN NOT (`Condition_1` = 'Norm') THEN 0.0 END AS Condition_1_Norm
#> <SQL> CASE WHEN (`Condition_1` = 'other') THEN 1.0 WHEN NOT (`Condition_1` = 'other') THEN 0.0 END AS Condition_1_other
#> <SQL> CASE WHEN (`Bldg_Type` = 'TwnhsE') THEN 1.0 WHEN NOT (`Bldg_Type` = 'TwnhsE') THEN 0.0 END AS Bldg_Type_TwnhsE
#> <SQL> CASE WHEN (`Bldg_Type` = 'other') THEN 1.0 WHEN NOT (`Bldg_Type` = 'other') THEN 0.0 END AS Bldg_Type_other
#> <SQL> CASE WHEN (`House_Style` = 'One_Story') THEN 1.0 WHEN NOT (`House_Style` = 'One_Story') THEN 0.0 END AS House_Style_One_Story
#> <SQL> CASE WHEN (`House_Style` = 'Two_Story') THEN 1.0 WHEN NOT (`House_Style` = 'Two_Story') THEN 0.0 END AS House_Style_Two_Story
#> <SQL> CASE WHEN (`House_Style` = 'other') THEN 1.0 WHEN NOT (`House_Style` = 'other') THEN 0.0 END AS House_Style_other
#> <SQL> CASE WHEN (`Overall_Cond` = 'Above_Average') THEN 1.0 WHEN NOT (`Overall_Cond` = 'Above_Average') THEN 0.0 END AS Overall_Cond_Above_Average
#> <SQL> CASE WHEN (`Overall_Cond` = 'Good') THEN 1.0 WHEN NOT (`Overall_Cond` = 'Good') THEN 0.0 END AS Overall_Cond_Good
#> <SQL> CASE WHEN (`Overall_Cond` = 'other') THEN 1.0 WHEN NOT (`Overall_Cond` = 'other') THEN 0.0 END AS Overall_Cond_other
#> <SQL> CASE WHEN (`Roof_Style` = 'Hip') THEN 1.0 WHEN NOT (`Roof_Style` = 'Hip') THEN 0.0 END AS Roof_Style_Hip
#> <SQL> CASE WHEN (`Exterior_1st` = 'Plywood') THEN 1.0 WHEN NOT (`Exterior_1st` = 'Plywood') THEN 0.0 END AS Exterior_1st_Plywood
#> <SQL> CASE WHEN (`Exterior_1st` = 'Wd Sdng') THEN 1.0 WHEN NOT (`Exterior_1st` = 'Wd Sdng') THEN 0.0 END AS Exterior_1st_Wd.Sdng
#> <SQL> CASE WHEN (`Exterior_1st` = 'other') THEN 1.0 WHEN NOT (`Exterior_1st` = 'other') THEN 0.0 END AS Exterior_1st_other
#> <SQL> CASE WHEN (`Exterior_2nd` = 'MetalSd') THEN 1.0 WHEN NOT (`Exterior_2nd` = 'MetalSd') THEN 0.0 END AS Exterior_2nd_MetalSd
#> <SQL> CASE WHEN (`Exterior_2nd` = 'Plywood') THEN 1.0 WHEN NOT (`Exterior_2nd` = 'Plywood') THEN 0.0 END AS Exterior_2nd_Plywood
#> <SQL> CASE WHEN (`Exterior_2nd` = 'VinylSd') THEN 1.0 WHEN NOT (`Exterior_2nd` = 'VinylSd') THEN 0.0 END AS Exterior_2nd_VinylSd
#> <SQL> CASE WHEN (`Exterior_2nd` = 'Wd Sdng') THEN 1.0 WHEN NOT (`Exterior_2nd` = 'Wd Sdng') THEN 0.0 END AS Exterior_2nd_Wd.Sdng
#> <SQL> CASE WHEN (`Exterior_2nd` = 'other') THEN 1.0 WHEN NOT (`Exterior_2nd` = 'other') THEN 0.0 END AS Exterior_2nd_other
#> <SQL> CASE WHEN (`Mas_Vnr_Type` = 'None') THEN 1.0 WHEN NOT (`Mas_Vnr_Type` = 'None') THEN 0.0 END AS Mas_Vnr_Type_None
#> <SQL> CASE WHEN (`Mas_Vnr_Type` = 'Stone') THEN 1.0 WHEN NOT (`Mas_Vnr_Type` = 'Stone') THEN 0.0 END AS Mas_Vnr_Type_Stone
#> <SQL> CASE WHEN (`Exter_Cond` = 'Typical') THEN 1.0 WHEN NOT (`Exter_Cond` = 'Typical') THEN 0.0 END AS Exter_Cond_Typical
#> <SQL> CASE WHEN (`Foundation` = 'CBlock') THEN 1.0 WHEN NOT (`Foundation` = 'CBlock') THEN 0.0 END AS Foundation_CBlock
#> <SQL> CASE WHEN (`Foundation` = 'PConc') THEN 1.0 WHEN NOT (`Foundation` = 'PConc') THEN 0.0 END AS Foundation_PConc
#> <SQL> CASE WHEN (`Bsmt_Cond` = 'other') THEN 1.0 WHEN NOT (`Bsmt_Cond` = 'other') THEN 0.0 END AS Bsmt_Cond_other
#> <SQL> CASE WHEN (`Bsmt_Exposure` = 'Gd') THEN 1.0 WHEN NOT (`Bsmt_Exposure` = 'Gd') THEN 0.0 END AS Bsmt_Exposure_Gd
#> <SQL> CASE WHEN (`Bsmt_Exposure` = 'Mn') THEN 1.0 WHEN NOT (`Bsmt_Exposure` = 'Mn') THEN 0.0 END AS Bsmt_Exposure_Mn
#> <SQL> CASE WHEN (`Bsmt_Exposure` = 'No') THEN 1.0 WHEN NOT (`Bsmt_Exposure` = 'No') THEN 0.0 END AS Bsmt_Exposure_No
#> <SQL> CASE WHEN (`BsmtFin_Type_1` = 'BLQ') THEN 1.0 WHEN NOT (`BsmtFin_Type_1` = 'BLQ') THEN 0.0 END AS BsmtFin_Type_1_BLQ
#> <SQL> CASE WHEN (`BsmtFin_Type_1` = 'GLQ') THEN 1.0 WHEN NOT (`BsmtFin_Type_1` = 'GLQ') THEN 0.0 END AS BsmtFin_Type_1_GLQ
#> <SQL> CASE WHEN (`BsmtFin_Type_1` = 'LwQ') THEN 1.0 WHEN NOT (`BsmtFin_Type_1` = 'LwQ') THEN 0.0 END AS BsmtFin_Type_1_LwQ
#> <SQL> CASE WHEN (`BsmtFin_Type_1` = 'Rec') THEN 1.0 WHEN NOT (`BsmtFin_Type_1` = 'Rec') THEN 0.0 END AS BsmtFin_Type_1_Rec
#> <SQL> CASE WHEN (`BsmtFin_Type_1` = 'Unf') THEN 1.0 WHEN NOT (`BsmtFin_Type_1` = 'Unf') THEN 0.0 END AS BsmtFin_Type_1_Unf
#> <SQL> CASE WHEN (`BsmtFin_Type_2` = 'other') THEN 1.0 WHEN NOT (`BsmtFin_Type_2` = 'other') THEN 0.0 END AS BsmtFin_Type_2_other
#> <SQL> CASE WHEN (`Heating_QC` = 'Good') THEN 1.0 WHEN NOT (`Heating_QC` = 'Good') THEN 0.0 END AS Heating_QC_Good
#> <SQL> CASE WHEN (`Heating_QC` = 'Typical') THEN 1.0 WHEN NOT (`Heating_QC` = 'Typical') THEN 0.0 END AS Heating_QC_Typical
#> <SQL> CASE WHEN (`Central_Air` = 'Y') THEN 1.0 WHEN NOT (`Central_Air` = 'Y') THEN 0.0 END AS Central_Air_Y
#> <SQL> CASE WHEN (`Electrical` = 'SBrkr') THEN 1.0 WHEN NOT (`Electrical` = 'SBrkr') THEN 0.0 END AS Electrical_SBrkr
#> <SQL> CASE WHEN (`Functional` = 'other') THEN 1.0 WHEN NOT (`Functional` = 'other') THEN 0.0 END AS Functional_other
#> <SQL> CASE WHEN (`Garage_Type` = 'BuiltIn') THEN 1.0 WHEN NOT (`Garage_Type` = 'BuiltIn') THEN 0.0 END AS Garage_Type_BuiltIn
#> <SQL> CASE WHEN (`Garage_Type` = 'Detchd') THEN 1.0 WHEN NOT (`Garage_Type` = 'Detchd') THEN 0.0 END AS Garage_Type_Detchd
#> <SQL> CASE WHEN (`Garage_Type` = 'No_Garage') THEN 1.0 WHEN NOT (`Garage_Type` = 'No_Garage') THEN 0.0 END AS Garage_Type_No_Garage
#> <SQL> CASE WHEN (`Garage_Finish` = 'RFn') THEN 1.0 WHEN NOT (`Garage_Finish` = 'RFn') THEN 0.0 END AS Garage_Finish_RFn
#> <SQL> CASE WHEN (`Garage_Finish` = 'Unf') THEN 1.0 WHEN NOT (`Garage_Finish` = 'Unf') THEN 0.0 END AS Garage_Finish_Unf
#> <SQL> CASE WHEN (`Garage_Cond` = 'Typical') THEN 1.0 WHEN NOT (`Garage_Cond` = 'Typical') THEN 0.0 END AS Garage_Cond_Typical
#> <SQL> CASE WHEN (`Paved_Drive` = 'Paved') THEN 1.0 WHEN NOT (`Paved_Drive` = 'Paved') THEN 0.0 END AS Paved_Drive_Paved
#> <SQL> CASE WHEN (`Fence` = 'No_Fence') THEN 1.0 WHEN NOT (`Fence` = 'No_Fence') THEN 0.0 END AS Fence_No_Fence
#> <SQL> CASE WHEN (`Fence` = 'other') THEN 1.0 WHEN NOT (`Fence` = 'other') THEN 0.0 END AS Fence_other
#> <SQL> CASE WHEN (`Sale_Type` = 'WD ') THEN 1.0 WHEN NOT (`Sale_Type` = 'WD ') THEN 0.0 END AS Sale_Type_WD.
#> <SQL> CASE WHEN (`Sale_Type` = 'other') THEN 1.0 WHEN NOT (`Sale_Type` = 'other') THEN 0.0 END AS Sale_Type_other
#> <SQL> CASE WHEN (`Sale_Condition` = 'Normal') THEN 1.0 WHEN NOT (`Sale_Condition` = 'Normal') THEN 0.0 END AS Sale_Condition_Normal
#> <SQL> CASE WHEN (`Sale_Condition` = 'Partial') THEN 1.0 WHEN NOT (`Sale_Condition` = 'Partial') THEN 0.0 END AS Sale_Condition_Partial
